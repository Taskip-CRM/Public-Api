...
|-------|------|----------|-------------|
| `message` | string | Yes | Reply message content |
| `is_internal` | boolean | No | Internal note (not visible to client) - default: false |
| `attachments` | array | No | Array of attachment file IDs |
| `notify_client` | boolean | No | Send email notification to client - default: true |
...
curl -X POST "https://public-api.taskip.net/api/public-v1/support-ticket/reply/abc123def456" \
  ...
  -H "Content-Type: application/json" \
  -d '{
    "message": "Thank you for contacting us. We have reviewed your issue and will provide a solution shortly.",
    "is_internal": false,
    "notify_client": true,
    "attachments": [123, 124]
  }'
    ...
    "attachments": [
      {
        ...
        "size": 245760,
        "url": "https://cdn.taskip.net/files/solution_guide.pdf"
      },
      {
        "id": 124, 
        "filename": "screenshot.png",
        "size": 89420,
        "url": "https://cdn.taskip.net/files/screenshot.png"
      }
    ],
