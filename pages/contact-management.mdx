...
|--------|----------|-------------|
| `GET` | [`/api/public-v1/contact`](#get-all-contacts) | Get all contacts |
| `POST` | [`/api/public-v1/contact`](#create-a-contact) | Create a new contact |
| `GET` | [`/api/public-v1/contact/{id}`](#get-a-specific-contact) | Get a specific contact |
| `PUT` | [`/api/public-v1/contact/{id}`](#update-a-contact) | Update a contact |
| `DELETE` | [`/api/public-v1/contact/{contact}`](#delete-a-contact) | Delete a contact |
| `POST` | [`/api/public-v1/contact/bulk-delete`](#bulk-delete-contacts) | Delete multiple contacts |
| `POST` | [`/api/public-v1/contact/invite-client/{id}`](#invite-client) | Invite a contact as client |
...
<ApiTester
  ...
  defaultBody={{
    ...
    "details": "Promoted to senior position"
  }}
...
<ApiTester
  endpoint="/api/public-v1/contact/1"
  method="DELETE"
...
<ApiTester
  endpoint="/api/public-v1/contact/bulk-delete"
  method="POST"
  defaultBody={{
    "contact_ids": [1, 2, 3]
  }}
...
<ApiTester
  endpoint="/api/public-v1/contact/invite-client/1"
  method="POST"
  defaultBody={{
